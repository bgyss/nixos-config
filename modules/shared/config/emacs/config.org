...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Brian Gyss"
    user-mail-address "bgyss@hey.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/briangyss/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/briangyss/bin" "/profile/bin" "/Users/briangyss/.npm-packages/bin" "/Users/briangyss/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
...
This block sets the ~org-agenda-prefix-format~ in an friendly way for ~org-roam~ (credit to [[https://d12frosted.io/posts/2020-06-24-ta***REDACTED-SECRET***.html][this post)]]. It truncates long filenames and removes the ~org-roam~ timestamp slug.
